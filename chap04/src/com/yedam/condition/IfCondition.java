...
public class IfCondition {
	public static void main(String[] args) {
		...
		/*
		 * score = 95; if (score >= 90) { System.out.println("===등급 A"); } else if
		 * (score >= 80) { System.out.println("등급 B"); } else if (score >= 70) {
		 * System.out.println("등급 C"); } else { System.out.println("등급 D"); }
		 * 
		 * if (score >= 90) { System.out.println("등급 A"); } if (score >= 80) {
		 * System.out.println("등급 B"); } if (score >= 70) { System.out.println("등급 C");
		 * } else { System.out.println("등급 D"); }
		 */

		// random 값 추출
		// Random() / Mate.random()
		// 0 <= Math.ramdom() < 1 => 0 ~ 0.9xxxx
...
//		}
		...
		System.out.println("획득학 학점 : " + grade);
